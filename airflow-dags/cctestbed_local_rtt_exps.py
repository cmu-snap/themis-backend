...
for btlbw, rtt, queue_size in ntwrk_conditions:
    ntwrk_cmdline_args += '-n {} {} {}'.format(bltbw, rtt, queue_size)
...
with DAG("cctestbed_local",
    ...
    run_experiment = BashOperator(task_id='run_experiment',
                                  bash_command=(
                                      "cd /opt/cctestbed && "
                                      "python3.6 /opt/cctestbed/ccalg_predict_iperf.py -r local -c {{ dag_run.conf['cca'] }} {} --force".format(ntwrk_cmdline_args)))
